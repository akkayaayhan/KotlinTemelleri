package com.akkayasoft.kotlintemelleri
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mixedArray = arrayOf("ayhan",5)
        ...
        myStringArrayList.add("Ayhan")
        myStringArrayList.add("Akkaya")
        myStringArrayList.add("Yazılım")
